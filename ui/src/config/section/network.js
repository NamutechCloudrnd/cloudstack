...
export default {
  ...
  title: 'label.network',
  icon: 'wifi-outlined',
  docHelp: '#/03_network/01_guest_networks/guest_networks.html',
  children: [
    {
      name: 'guestnetwork',
    ...
    },
    {
      ...
      docHelp: '#/03_network/02_vpc/vpc.html',
      permission: ['listVPCs'],
      resourceType: 'Vpc',
      columns: () => {
    ...
    },
    {
      ...
      icon: 'fire-outlined',
      docHelp: '#/03_network/03_security_group/security_group.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/04_vnf_appliances/vnf_appliances.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/05_public_ip_addresses/public_ip_addresses.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/06_as_numbers/as_numbers.html',
    ...
    },
    {
      ...
      icon: 'lock-outlined',
      docHelp: '#/03_network/07_site_to_site_vpn/site_to_site_vpn.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/08_vpn_connections/vpn_connections.html',
      icon: 'sync-outlined',
    ...
    },
    {
      ...
      icon: 'bars-outlined',
      docHelp: '#/03_network/09_network_acls/network_acls.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/10_vpn_users/vpn_users.html',
    ...
    },
    {
      ...
      icon: 'lock-outlined',
      docHelp: '#/03_network/11_vpn_customer_gateway/vpn_customer_gateway.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/12_guest_vlan/guest_vlan.html',
    ...
    },
    {
      ...
      docHelp: '#/03_network/13_ipv4_subnets/ipv4_subnets.html',
